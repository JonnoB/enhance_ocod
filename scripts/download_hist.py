...
PRICE_PAID_DIR = Path('enhance_ocod/data/price_paid_data')
...
def main():
    ...
    # Download the price_paid dataset only if no files exist in the target directory
    ...
    if check_directory_has_files(VOA_DIR):
        ...
        downloader.download_file(latest_baseline, str(VOA_DIR))
