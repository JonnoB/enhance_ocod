...
def run_experiment(data_folder, train_file, model_suffix, **kwargs):
    ...
    cmd = [
        sys.executable, "mbert_train_configurable.py",
...
def main():
    ...
    print(f"  - address_parser_original_devset")
    print(f"  - address_parser_original_fullset") 
    print(f"  - address_parser_preprocessed_devset")
    print(f"  - address_parser_preprocessed_fullset")
