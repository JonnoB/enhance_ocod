...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Train NER model with configurable data sources"
    )
    ...
    parser.add_argument(
        "--train_file", type=str, required=True, help="Training data file to use"
    )
...
def main():
    ...
    val_data_path = str(
        data_base_path / "ground_truth_test_set_labels.json"
    )  # Always use test set for validation
    ...
    print("  Validation file: ground_truth_test_set_labels.json")
