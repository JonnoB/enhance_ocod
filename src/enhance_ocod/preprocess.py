...
def preprocess_text_for_tokenization(text: Union[str, pd.Series]) -> Union[str, pd.Series]:
    """
    ...
    if isinstance(text, pd.Series):
        ...
        for pattern, replacement in patterns_replacements:
            processed_series = processed_series.str.replace(pattern, replacement, regex=True)
